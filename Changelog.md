...
|16.04.2022|Get-TeamsUserCallingSettings.ps1|1.0.0|Finalize first version of function for standalone use. Create example script to run the function for each enabled user of a tenant.|