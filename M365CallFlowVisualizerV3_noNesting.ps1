...
<#     if (!$aaDefaultCallFlowCounter) {
    ...
    if ($defaultCallFlowAction -eq "TransferCallToTarget") {
        ...
        # Check if default callflow action target is trasnfer call to target but something other than call queue
            ...
            $mdAutoAttendantDefaultCallFlow = "defaultCallFlowGreeting$($aaDefaultCallFlowCounter)>$defaultCallFlowGreeting] --> defaultCallFlow$($aaDefaultCallFlowCounter)($defaultCallFlowAction) --> $($defaultCallFlowTargetIdentity)($defaultCallFlowTargetTypeFriendly <br> $defaultCallFlowTargetName)"
...
<#     if (!$aaAfterHoursCallFlowCounter) {
    ...
    $aaAfterHoursCallFlowCounter = $aa.Identity
    ...
    if ($afterHoursCallFlowAction -eq "TransferCallToTarget") {
        ...
        switch ($afterHoursCallFlowTargetType) {
            ...
            ApplicationEndpoint {
                ...
                if ($MatchingAaAfterHoursCallFlowAa) {
                    ...
                    Write-Host "Matching AA for after hours transfer target: $($MatchingAaAfterHoursCallFlowAa.Name)" -ForegroundColor Blue
        ...
        # Check if AfterHours callflow action target is trasnfer call to target but something other than call queue
            ...
            $mdAutoAttendantAfterHoursCallFlow = "afterHoursCallFlowGreeting$($aaAfterHoursCallFlowCounter)>$AfterHoursCallFlowGreeting] --> AfterHoursCallFlow$($aaAfterHoursCallFlowCounter)($AfterHoursCallFlowAction) --> $($afterHoursCallFlowTargetIdentity)($AfterHoursCallFlowTargetTypeFriendly <br> $AfterHoursCallFlowTargetName)"
            
            Write-Host "Other" -ForegroundColor Blue
...
<#     if (!$cqCallFlowCounter) {
    ...
    $cqCallFlowCounter = $MatchingCQ.Identity
    ...
    switch ($CqOverFlowAction) {
        ...
        SharedVoicemail {
            ...
            $CqOverFlowActionFriendly = "cqOverFlowAction$($cqCallFlowCounter)(TransferCallToTarget) --> cqOverFlowVoicemailGreeting$($cqCallFlowCounter)>Greeting <br> $CqOverFlowVoicemailGreeting] --> $($MatchingOverFlowIdentity)(Shared Voicemail <br> $MatchingOverFlowVoicemail)"
    ...
    switch ($CqTimeoutAction) {
        ...
        Forward {
            ...
            if ($MatchingCQ.TimeoutActionTarget.Type -eq "User") {
                ...
                $CqTimeoutActionFriendly = "cqTimeoutAction$($cqCallFlowCounter)(TransferCallToTarget) --> $($MatchingTimeoutIdentity)(User <br> $MatchingTimeoutUser)"
            ...
            elseif ($MatchingCQ.TimeoutActionTarget.Type -eq "Phone") {
                ...
                $CqTimeoutActionFriendly = "cqTimeoutAction$($cqCallFlowCounter)(TransferCallToTarget) --> $($cqTimeoutPhoneNumber)(External Number <br> $cqTimeoutPhoneNumber)"
        ...
        SharedVoicemail {
            ...
            $CqTimeoutActionFriendly = "cqTimeoutAction$($cqCallFlowCounter)(TransferCallToTarget) --> cqTimeoutVoicemailGreeting$($cqCallFlowCounter)>Greeting <br> $CqTimeoutVoicemailGreeting] --> $($MatchingTimeoutIdentity)(Shared Voicemail <br> $MatchingTimeoutVoicemail)"
...
"@
    ...
    $MarkdownConnections += $MarkdownConnectionsCurrentVoiceApp
